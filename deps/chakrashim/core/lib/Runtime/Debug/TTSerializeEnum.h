...
ENTRY_SERIALIZE_ENUM(handlerObjId)
...
ENTRY_SERIALIZE_ENUM(promiseCapInfo)
ENTRY_SERIALIZE_ENUM(promiseInfo)
ENTRY_SERIALIZE_ENUM(promiseReactionId)
ENTRY_SERIALIZE_ENUM(promiseVar)
ENTRY_SERIALIZE_ENUM(properties)
ENTRY_SERIALIZE_ENUM(randomSeed0)
ENTRY_SERIALIZE_ENUM(randomSeed1)
ENTRY_SERIALIZE_ENUM(rejectVar)
ENTRY_SERIALIZE_ENUM(rejectReactions)
ENTRY_SERIALIZE_ENUM(resolveVar)
ENTRY_SERIALIZE_ENUM(resolveReactions)
